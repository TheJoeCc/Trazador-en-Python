...
def detectar_objetos_circulares(frame):
    ...
    # Detectar los objetos circulares utilizando el algoritmo de detección Hough Circles
    circulos = cv2.HoughCircles(suavizado, cv2.HOUGH_GRADIENT, 1, minDist=100,
                               param1=50, param2=30, minRadius=10, maxRadius=200)

    # A ver si se detectaron los círculos
    if circulos is not None:
        ...
        for (x, y, r) in circulos:
            ...
            # Trazar la trayectoria del círculo
    ...
    # Contador de tiempo todo bonito
